...
.field public static final e:Lkotlinx/coroutines/l;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkotlinx/coroutines/l;->e:Lkotlinx/coroutines/l;
    ...
    .line 3
    invoke-static {v0}, Lkotlin/l0/o;->q(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    .line 7
    :goto_1
    sput v0, Lkotlinx/coroutines/l;->c:I
...
.method private final K()Ljava/util/concurrent/ExecutorService;
    ...
    .line 2
    invoke-direct {p0}, Lkotlinx/coroutines/l;->V()I
...
.method private final N()Ljava/util/concurrent/ExecutorService;
    ...
    invoke-direct {p0}, Lkotlinx/coroutines/l;->K()Ljava/util/concurrent/ExecutorService;
    ...
    .line 3
    sget-boolean v2, Lkotlinx/coroutines/l;->d:Z

    const/4 v3, 0x0

    if-nez v2, :cond_4

    sget v2, Lkotlinx/coroutines/l;->c:I
    ...
    .line 5
    sget-object v4, Lkotlinx/coroutines/l;->e:Lkotlinx/coroutines/l;

    invoke-virtual {v4, v1, v2}, Lkotlinx/coroutines/l;->a0(Ljava/lang/Class;Ljava/util/concurrent/ExecutorService;)Z
    ...
    invoke-direct {v4}, Lkotlinx/coroutines/l;->V()I
...
.method private final declared-synchronized O()Ljava/util/concurrent/Executor;
    ...
    :cond_0
    invoke-direct {p0}, Lkotlinx/coroutines/l;->N()Ljava/util/concurrent/ExecutorService;

    move-result-object v0

    sput-object v0, Lkotlinx/coroutines/l;->pool:Ljava/util/concurrent/Executor;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private final V()I
    ...
    .line 1
    sget v0, Lkotlinx/coroutines/l;->c:I
...
.method public A(Lkotlin/c0/f;Ljava/lang/Runnable;)V
    ...
    :cond_0
    invoke-direct {p0}, Lkotlinx/coroutines/l;->O()Ljava/util/concurrent/Executor;
    ...
    invoke-interface {v0, p2}, Lkotlinx/coroutines/e1;->a(Ljava/lang/Runnable;)Ljava/lang/Runnable;
    ...
    .line 3
    :cond_2
    sget-object p1, Lkotlinx/coroutines/z;->h:Lkotlinx/coroutines/z;

    invoke-virtual {p1, p2}, Lkotlinx/coroutines/g0;->y0(Ljava/lang/Runnable;)V
...
.method public final a0(Ljava/lang/Class;Ljava/util/concurrent/ExecutorService;)Z
    ...
    .line 1
    sget-object v0, Lkotlinx/coroutines/l$b;->a:Lkotlinx/coroutines/l$b;
