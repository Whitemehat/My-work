...
.field private final hpackBuffer:Lj/f;
...
.method public constructor <init>(Lj/g;Z)V
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lj/g;
    ...
    iput-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lj/f;
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLj/f;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method private final writeContinuationFrames(IJ)V
    ...
    .line 3
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lj/g;

    iget-object v1, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lj/f;
...
.method public final declared-synchronized applyAndAckSettings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 6
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lj/g;
...
.method public final declared-synchronized connectionPreface()V
    ...
    sget-object v2, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lj/i;

    invoke-virtual {v2}, Lj/i;->F()Ljava/lang/String;
    ...
    sget-object v1, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lj/i;

    invoke-interface {v0, v1}, Lj/g;->K0(Lj/i;)Lj/g;
...
.method public final declared-synchronized data(ZILj/f;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 2
    :cond_0
    invoke-virtual {p0, p2, v0, p3, p4}, Lokhttp3/internal/http2/Http2Writer;->dataFrame(IILj/f;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final dataFrame(IILj/f;I)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p1, p3, v0, v1}, Lj/c0;->write(Lj/f;J)V
...
.method public final frameHeader(IIII)V
    ...
    invoke-static {v0, p2}, Lokhttp3/internal/Util;->writeMedium(Lj/g;I)V

    .line 4
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lj/g;

    and-int/lit16 p3, p3, 0xff

    invoke-interface {p2, p3}, Lj/g;->R(I)Lj/g;
    ...
    invoke-interface {p2, p1}, Lj/g;->D(I)Lj/g;
...
.method public final declared-synchronized goAway(ILokhttp3/internal/http2/ErrorCode;[B)V
    ...
    invoke-interface {v0, p1}, Lj/g;->D(I)Lj/g;
    ...
    invoke-interface {p1, p2}, Lj/g;->D(I)Lj/g;
    ...
    invoke-interface {p1, p3}, Lj/g;->write([B)Lj/g;
...
.method public final declared-synchronized headers(ZILjava/util/List;)V
    ...
    .line 3
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lj/f;

    invoke-virtual {p3}, Lj/f;->O0()J
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lj/f;

    invoke-interface {p1, v4, v2, v3}, Lj/c0;->write(Lj/f;J)V
...
.method public final declared-synchronized ping(ZII)V
    ...
    invoke-interface {p1, p3}, Lj/g;->D(I)Lj/g;
...
.method public final declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    .line 6
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lj/g;

    const v3, 0x7fffffff

    and-int/2addr p2, v3

    invoke-interface {v2, p2}, Lj/g;->D(I)Lj/g;

    .line 7
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lj/g;

    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lj/f;

    invoke-interface {p2, v2, v4, v5}, Lj/c0;->write(Lj/f;J)V
...
.method public final declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 5
    :goto_1
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lj/g;

    invoke-interface {v4, v3}, Lj/g;->x(I)Lj/g;

    .line 6
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lj/g;

    invoke-virtual {p1, v2}, Lokhttp3/internal/http2/Settings;->get(I)I

    move-result v4

    invoke-interface {v3, v4}, Lj/g;->D(I)Lj/g;
