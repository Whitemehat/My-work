...
.method public constructor <init>(Lokhttp3/internal/http2/Http2Connection$Builder;)V
    ...
    invoke-virtual {p1}, Lokhttp3/internal/http2/Http2Connection$Builder;->getSink$okhttp()Lj/g;

    move-result-object v4

    invoke-direct {v2, v4, v0}, Lokhttp3/internal/http2/Http2Writer;-><init>(Lj/g;Z)V
    ...
    invoke-virtual {p1}, Lokhttp3/internal/http2/Http2Connection$Builder;->getSource$okhttp()Lj/h;

    move-result-object v5

    invoke-direct {v4, v5, v0}, Lokhttp3/internal/http2/Http2Reader;-><init>(Lj/h;Z)V
...
.method public final pushDataLater$okhttp(ILj/h;IZ)V
    .locals 11
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 2
    invoke-interface {p2, v0, v1}, Lj/h;->Z0(J)V

    .line 3
    invoke-interface {p2, v8, v0, v1}, Lj/e0;->read(Lj/f;J)J
    ...
    invoke-direct/range {v1 .. v10}, Lokhttp3/internal/http2/Http2Connection$pushDataLater$$inlined$execute$1;-><init>(Ljava/lang/String;ZLjava/lang/String;ZLokhttp3/internal/http2/Http2Connection;ILj/f;IZ)V
...
.method public final writeData(IZLj/f;J)V
    .locals 9
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {p4, p2, p1, p3, v3}, Lokhttp3/internal/http2/Http2Writer;->data(ZILj/f;I)V
    ...
    iput v4, v2, Lkotlin/jvm/internal/b0;->a:I
    ...
    :goto_2
    invoke-virtual {v2, v5, p1, p3, v4}, Lokhttp3/internal/http2/Http2Writer;->data(ZILj/f;I)V
