...
.method public constructor <init>(Lj/h;Z)V
    .locals 7
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lj/h;
    ...
    invoke-direct {v2, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Lj/h;)V
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lj/e0;IIILkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method private final readData(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 1
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lj/h;

    invoke-interface {v1}, Lj/h;->m0()B
    ...
    .line 3
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lj/h;

    invoke-interface {p1, v0, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILj/h;I)V

    .line 4
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lj/h;

    int-to-long p2, v1

    invoke-interface {p1, p2, p3}, Lj/h;->skip(J)V
...
.method private final readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 1
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lj/h;

    invoke-interface {p4}, Lj/h;->C()I

    move-result p4

    .line 2
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lj/h;

    invoke-interface {v0}, Lj/h;->C()I
    ...
    invoke-interface {v0, v1, v2}, Lj/h;->s(J)Lj/i;

    move-result-object v0

    .line 6
    :cond_0
    invoke-interface {p1, p4, p3, v0}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;Lj/i;)V
...
.method private final readPing(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 1
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lj/h;
...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    .line 5
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lj/h;
...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 5
    invoke-static {v0, p2}, Lkotlin/i0/d;->j(II)Lkotlin/i0/c;

    move-result-object p2

    const/4 v1, 0x6

    invoke-static {p2, v1}, Lkotlin/i0/d;->i(Lkotlin/i0/a;I)Lkotlin/i0/a;

    move-result-object p2

    invoke-virtual {p2}, Lkotlin/i0/a;->i()I

    move-result v1

    invoke-virtual {p2}, Lkotlin/i0/a;->k()I

    move-result v2

    invoke-virtual {p2}, Lkotlin/i0/a;->l()I
    ...
    .line 7
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lj/h;

    invoke-interface {v4}, Lj/h;->C()I
...
.method public final nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-static {v0}, Lokhttp3/internal/Util;->readMedium(Lj/h;)I
    ...
    invoke-interface {p1, v0, v1}, Lj/h;->skip(J)V
...
.method public final readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    sget-object v0, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lj/i;
    ...
    invoke-interface {p1, v2, v3}, Lj/h;->s(J)Lj/i;
    ...
    invoke-virtual {p1}, Lj/i;->U()Ljava/lang/String;
