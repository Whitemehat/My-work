...
# direct methods
.method public constructor <init>(Lj/e0;I)V
    .locals 6
    ...
    invoke-direct/range {v0 .. v5}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lj/e0;IIILkotlin/jvm/internal/DefaultConstructorMarker;)V

    return-void
.end method

.method public constructor <init>(Lj/e0;II)V
    .locals 1
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lj/h;
...
.method public synthetic constructor <init>(Lj/e0;IIILkotlin/jvm/internal/DefaultConstructorMarker;)V
    .locals 0
    ...
    .line 6
    :cond_0
    invoke-direct {p0, p1, p2, p3}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lj/e0;II)V
...
.method private final getName(I)Lj/i;
    .locals 3
    ...
    iget-object p1, p1, Lokhttp3/internal/http2/Header;->name:Lj/i;
...
.method private final readByte()I
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lj/h;
...
.method private final readLiteralHeaderWithIncrementalIndexingIndexedName(I)V
    ...
    .line 1
    invoke-direct {p0, p1}, Lokhttp3/internal/http2/Hpack$Reader;->getName(I)Lj/i;

    move-result-object p1

    .line 2
    invoke-virtual {p0}, Lokhttp3/internal/http2/Hpack$Reader;->readByteString()Lj/i;
    ...
    invoke-direct {v1, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Lj/i;Lj/i;)V
...
.method private final readLiteralHeaderWithIncrementalIndexingNewName()V
    ...
    invoke-virtual {v0, v1}, Lokhttp3/internal/http2/Hpack;->checkLowercase(Lj/i;)Lj/i;
    ...
    invoke-direct {v2, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Lj/i;Lj/i;)V
...
.method private final readLiteralHeaderWithoutIndexingIndexedName(I)V
    ...
    invoke-direct {v2, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Lj/i;Lj/i;)V
...
.method private final readLiteralHeaderWithoutIndexingNewName()V
    ...
    invoke-direct {v3, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Lj/i;Lj/i;)V
...
.method public final readByteString()Lj/i;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lj/h;

    invoke-virtual {v1, v4, v2, v3, v0}, Lokhttp3/internal/http2/Huffman;->decode(Lj/h;JLj/g;)V
    ...
    invoke-interface {v0, v2, v3}, Lj/h;->s(J)Lj/i;
