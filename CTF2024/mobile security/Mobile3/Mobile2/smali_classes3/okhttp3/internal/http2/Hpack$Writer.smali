...
# direct methods
.method public constructor <init>(ILj/f;)V
    .locals 6
    ...
    invoke-direct/range {v0 .. v5}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLj/f;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    return-void
.end method

.method public constructor <init>(IZLj/f;)V
    .locals 1
    ...
    iput-object p3, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lj/f;
...
.method public synthetic constructor <init>(IZLj/f;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    .locals 0
    ...
    .line 6
    :cond_1
    invoke-direct {p0, p1, p2, p3}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLj/f;)V
...
.method private final clearDynamicTable()V
    ...
    invoke-static/range {v0 .. v5}, Lkotlin/a0/j;->m([Ljava/lang/Object;Ljava/lang/Object;IIILjava/lang/Object;)V
...
.method public final writeByteString(Lj/i;)V
    .locals 4
    ...
    invoke-virtual {v0, p1}, Lokhttp3/internal/http2/Huffman;->encodedLength(Lj/i;)I
    ...
    .line 3
    invoke-virtual {v0, p1, v2}, Lokhttp3/internal/http2/Huffman;->encode(Lj/i;Lj/g;)V

    .line 4
    invoke-virtual {v2}, Lj/f;->v0()Lj/i;
    ...
    .line 6
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lj/f;
...
.method public final writeHeaders(Ljava/util/List;)V
    ...
    .line 9
    iget-object v4, v3, Lokhttp3/internal/http2/Header;->name:Lj/i;

    invoke-virtual {v4}, Lj/i;->S()Lj/i;

    move-result-object v4

    .line 10
    iget-object v5, v3, Lokhttp3/internal/http2/Header;->value:Lj/i;
    ...
    iget-object v9, v9, Lokhttp3/internal/http2/Header;->value:Lj/i;

    invoke-static {v9, v5}, Lkotlin/jvm/internal/m;->c(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    iget-object v6, v6, Lokhttp3/internal/http2/Header;->value:Lj/i;
    ...
    :cond_6
    iget-object v11, v11, Lokhttp3/internal/http2/Header;->name:Lj/i;
    ...
    :cond_7
    iget-object v11, v11, Lokhttp3/internal/http2/Header;->value:Lj/i;

    invoke-static {v11, v5}, Lkotlin/jvm/internal/m;->c(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    .line 21
    iget-object v6, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lj/f;

    invoke-virtual {v6, v7}, Lj/f;->i1(I)Lj/f;

    .line 22
    invoke-virtual {p0, v4}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(Lj/i;)V

    .line 23
    invoke-virtual {p0, v5}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(Lj/i;)V
    ...
    .line 25
    :cond_c
    sget-object v8, Lokhttp3/internal/http2/Header;->PSEUDO_PREFIX:Lj/i;

    invoke-virtual {v4, v8}, Lj/i;->R(Lj/i;)Z

    move-result v8

    if-eqz v8, :cond_d

    sget-object v8, Lokhttp3/internal/http2/Header;->TARGET_AUTHORITY:Lj/i;
...
.method public final writeInt(III)V
    ...
    .line 1
    iget-object p2, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lj/f;
    ...
    invoke-virtual {v0, p3}, Lj/f;->i1(I)Lj/f;
    ...
    invoke-virtual {v0, p2}, Lj/f;->i1(I)Lj/f;
