...
.method private buildCall()Lokhttp3/Call;
    ...
    .line 19
    :goto_3
    invoke-virtual {v0}, Lokhttp3/internal/huc/OutputStreamRequestBody;->timeout()Lj/f0;
    ...
    invoke-virtual {v1, v3, v4, v5}, Lj/f0;->timeout(JLjava/util/concurrent/TimeUnit;)Lj/f0;
...
.method private static toHumanReadableAscii(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 5
    invoke-virtual {v6, p0, v1, v2}, Lj/f;->t1(Ljava/lang/String;II)Lj/f;

    const/16 v1, 0x3f

    .line 6
    invoke-virtual {v6, v1}, Lj/f;->u1(I)Lj/f;
    ...
    .line 10
    :cond_2
    invoke-virtual {v6}, Lj/f;->G0()Ljava/lang/String;
