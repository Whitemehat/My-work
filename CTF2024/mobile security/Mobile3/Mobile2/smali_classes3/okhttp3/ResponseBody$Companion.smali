...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "Lj/i;",
        "(Lj/i;Lokhttp3/MediaType;)Lokhttp3/ResponseBody;",
        "Lj/h;",
        "",
        "contentLength",
        "(Lj/h;Lokhttp3/MediaType;J)Lokhttp3/ResponseBody;",
        "asResponseBody",
        "content",
        "(Lokhttp3/MediaType;Ljava/lang/String;)Lokhttp3/ResponseBody;",
        "(Lokhttp3/MediaType;[B)Lokhttp3/ResponseBody;",
        "(Lokhttp3/MediaType;Lj/i;)Lokhttp3/ResponseBody;",
        "(Lokhttp3/MediaType;JLj/h;)Lokhttp3/ResponseBody;",
        "<init>",
        "()V",
        "okhttp"
    }
...
.method public static synthetic create$default(Lokhttp3/ResponseBody$Companion;Lj/h;Lokhttp3/MediaType;JILjava/lang/Object;)Lokhttp3/ResponseBody;
    .locals 0
    ...
    .line 4
    :cond_1
    invoke-virtual {p0, p1, p2, p3, p4}, Lokhttp3/ResponseBody$Companion;->create(Lj/h;Lokhttp3/MediaType;J)Lokhttp3/ResponseBody;
...
.method public static synthetic create$default(Lokhttp3/ResponseBody$Companion;Lj/i;Lokhttp3/MediaType;ILjava/lang/Object;)Lokhttp3/ResponseBody;
    .locals 0
    ...
    .line 3
    :cond_0
    invoke-virtual {p0, p1, p2}, Lokhttp3/ResponseBody$Companion;->create(Lj/i;Lokhttp3/MediaType;)Lokhttp3/ResponseBody;
...
# virtual methods
.method public final create(Lj/h;Lokhttp3/MediaType;J)Lokhttp3/ResponseBody;
    .locals 1
    ...
    invoke-direct {v0, p1, p2, p3, p4}, Lokhttp3/ResponseBody$Companion$asResponseBody$1;-><init>(Lj/h;Lokhttp3/MediaType;J)V

    return-object v0
.end method

.method public final create(Lj/i;Lokhttp3/MediaType;)Lokhttp3/ResponseBody;
    .locals 3
    ...
    invoke-virtual {p0, v0, p2, v1, v2}, Lokhttp3/ResponseBody$Companion;->create(Lj/h;Lokhttp3/MediaType;J)Lokhttp3/ResponseBody;
...
.method public final create(Ljava/lang/String;Lokhttp3/MediaType;)Lokhttp3/ResponseBody;
    ...
    invoke-virtual {v1, p1, v0}, Lj/f;->r1(Ljava/lang/String;Ljava/nio/charset/Charset;)Lj/f;
    ...
    invoke-virtual {p0, p1, p2, v0, v1}, Lokhttp3/ResponseBody$Companion;->create(Lj/h;Lokhttp3/MediaType;J)Lokhttp3/ResponseBody;
...
.method public final create(Lokhttp3/MediaType;JLj/h;)Lokhttp3/ResponseBody;
    .locals 1
    ...
    .line 16
    invoke-virtual {p0, p4, p1, p2, p3}, Lokhttp3/ResponseBody$Companion;->create(Lj/h;Lokhttp3/MediaType;J)Lokhttp3/ResponseBody;
...
.method public final create(Lokhttp3/MediaType;Lj/i;)Lokhttp3/ResponseBody;
    .locals 1
    ...
    .line 15
    invoke-virtual {p0, p2, p1}, Lokhttp3/ResponseBody$Companion;->create(Lj/i;Lokhttp3/MediaType;)Lokhttp3/ResponseBody;
