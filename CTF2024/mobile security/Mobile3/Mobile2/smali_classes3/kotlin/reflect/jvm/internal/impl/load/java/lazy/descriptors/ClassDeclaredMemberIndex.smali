...
.field private final memberFilter:Lkotlin/e0/c/l;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lkotlin/e0/c/l<",
...
.field private final methodFilter:Lkotlin/e0/c/l;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lkotlin/e0/c/l<",
...
# direct methods
.method public constructor <init>(Lkotlin/reflect/jvm/internal/impl/load/java/structure/JavaClass;Lkotlin/e0/c/l;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    iput-object p2, p0, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/ClassDeclaredMemberIndex;->memberFilter:Lkotlin/e0/c/l;
    ...
    iput-object p2, p0, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/ClassDeclaredMemberIndex;->methodFilter:Lkotlin/e0/c/l;
    ...
    invoke-static {p1, p2}, Lkotlin/k0/k;->m(Lkotlin/k0/h;Lkotlin/e0/c/l;)Lkotlin/k0/h;
    ...
    iget-object p2, p0, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/ClassDeclaredMemberIndex;->memberFilter:Lkotlin/e0/c/l;
    ...
    .line 24
    invoke-static {v0, p1}, Lkotlin/a0/p;->r(Ljava/lang/Iterable;I)I

    move-result p1

    invoke-static {p1}, Lkotlin/a0/j0;->d(I)I

    move-result p1

    const/16 p2, 0x10

    invoke-static {p1, p2}, Lkotlin/i0/d;->b(II)I
...
.method public static final synthetic access$getMemberFilter$p(Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/ClassDeclaredMemberIndex;)Lkotlin/e0/c/l;
    .locals 0

    .line 1
    iget-object p0, p0, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/ClassDeclaredMemberIndex;->memberFilter:Lkotlin/e0/c/l;
...
.method public getFieldNames()Ljava/util/Set;
    ...
    iget-object v1, p0, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/ClassDeclaredMemberIndex;->memberFilter:Lkotlin/e0/c/l;

    invoke-static {v0, v1}, Lkotlin/k0/k;->m(Lkotlin/k0/h;Lkotlin/e0/c/l;)Lkotlin/k0/h;
    ...
    .line 3
    check-cast v2, Lkotlin/reflect/jvm/internal/impl/load/java/structure/JavaNamedElement;
...
.method public getMethodNames()Ljava/util/Set;
    ...
    iget-object v1, p0, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/ClassDeclaredMemberIndex;->methodFilter:Lkotlin/e0/c/l;
