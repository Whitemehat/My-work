...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lretrofit2/q;->a:[C
    ...
    sput-object v0, Lretrofit2/q;->b:Ljava/util/regex/Pattern;
...
.method constructor <init>(Ljava/lang/String;Lokhttp3/HttpUrl;Ljava/lang/String;Lokhttp3/Headers;Lokhttp3/MediaType;ZZZ)V
    ...
    .line 3
    iput-object p2, p0, Lretrofit2/q;->d:Lokhttp3/HttpUrl;

    .line 4
    iput-object p3, p0, Lretrofit2/q;->e:Ljava/lang/String;
    ...
    iput-object p1, p0, Lretrofit2/q;->g:Lokhttp3/Request$Builder;

    .line 6
    iput-object p5, p0, Lretrofit2/q;->i:Lokhttp3/MediaType;

    .line 7
    iput-boolean p6, p0, Lretrofit2/q;->j:Z
    ...
    iput-object p1, p0, Lretrofit2/q;->h:Lokhttp3/Headers$Builder;
    ...
    iput-object p1, p0, Lretrofit2/q;->l:Lokhttp3/FormBody$Builder;
    ...
    iput-object p1, p0, Lretrofit2/q;->k:Lokhttp3/MultipartBody$Builder;
...
.method private static i(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    .line 6
    invoke-virtual {v3, p0, v1, v2}, Lj/f;->t1(Ljava/lang/String;II)Lj/f;

    .line 7
    invoke-static {v3, p0, v2, v0, p1}, Lretrofit2/q;->j(Lj/f;Ljava/lang/String;IIZ)V

    .line 8
    invoke-virtual {v3}, Lj/f;->G0()Ljava/lang/String;
...
.method private static j(Lj/f;Ljava/lang/String;IIZ)V
    .locals 6
    ...
    .line 3
    :cond_1
    invoke-virtual {p0, v1}, Lj/f;->u1(I)Lj/f;
    ...
    .line 5
    :cond_3
    invoke-virtual {v0, v1}, Lj/f;->u1(I)Lj/f;
    ...
    .line 8
    invoke-virtual {p0, v3}, Lj/f;->i1(I)Lj/f;

    .line 9
    sget-object v4, Lretrofit2/q;->a:[C
...
.method a(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    .line 1
    iget-object p3, p0, Lretrofit2/q;->l:Lokhttp3/FormBody$Builder;
...
.method b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lretrofit2/q;->i:Lokhttp3/MediaType;
    :try_end_0
    ...
    .line 4
    :cond_0
    iget-object v0, p0, Lretrofit2/q;->h:Lokhttp3/Headers$Builder;
...
.method d(Lokhttp3/Headers;Lokhttp3/RequestBody;)V
    ...
    .line 1
    iget-object v0, p0, Lretrofit2/q;->k:Lokhttp3/MultipartBody$Builder;
...
.method f(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    .line 1
    iget-object v0, p0, Lretrofit2/q;->e:Ljava/lang/String;
    ...
    .line 4
    sget-object p3, Lretrofit2/q;->b:Ljava/util/regex/Pattern;
    ...
    .line 5
    iput-object p1, p0, Lretrofit2/q;->e:Ljava/lang/String;
...
.method g(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    .line 2
    iget-object v1, p0, Lretrofit2/q;->d:Lokhttp3/HttpUrl;

    invoke-virtual {v1, v0}, Lokhttp3/HttpUrl;->newBuilder(Ljava/lang/String;)Lokhttp3/HttpUrl$Builder;

    move-result-object v0

    iput-object v0, p0, Lretrofit2/q;->f:Lokhttp3/HttpUrl$Builder;
    ...
    .line 3
    iput-object v0, p0, Lretrofit2/q;->e:Ljava/lang/String;
    ...
    iget-object p3, p0, Lretrofit2/q;->d:Lokhttp3/HttpUrl;
    ...
    iget-object p3, p0, Lretrofit2/q;->e:Ljava/lang/String;
    ...
    .line 5
    iget-object p3, p0, Lretrofit2/q;->f:Lokhttp3/HttpUrl$Builder;
...
.method h(Ljava/lang/Class;Ljava/lang/Object;)V
    ...
    .line 1
    iget-object v0, p0, Lretrofit2/q;->g:Lokhttp3/Request$Builder;
...
.method k()Lokhttp3/Request$Builder;
    ...
    .line 1
    iget-object v0, p0, Lretrofit2/q;->f:Lokhttp3/HttpUrl$Builder;
    ...
    .line 3
    :cond_0
    iget-object v0, p0, Lretrofit2/q;->d:Lokhttp3/HttpUrl;

    iget-object v1, p0, Lretrofit2/q;->e:Ljava/lang/String;
    ...
    .line 4
    :goto_0
    iget-object v1, p0, Lretrofit2/q;->m:Lokhttp3/RequestBody;

    if-nez v1, :cond_3

    .line 5
    iget-object v2, p0, Lretrofit2/q;->l:Lokhttp3/FormBody$Builder;
    ...
    .line 7
    :cond_1
    iget-object v2, p0, Lretrofit2/q;->k:Lokhttp3/MultipartBody$Builder;
    ...
    .line 9
    :cond_2
    iget-boolean v2, p0, Lretrofit2/q;->j:Z
    ...
    :cond_3
    :goto_1
    iget-object v2, p0, Lretrofit2/q;->i:Lokhttp3/MediaType;
    ...
    invoke-direct {v3, v1, v2}, Lretrofit2/q$a;-><init>(Lokhttp3/RequestBody;Lokhttp3/MediaType;)V
    ...
    .line 13
    :cond_4
    iget-object v3, p0, Lretrofit2/q;->h:Lokhttp3/Headers$Builder;
    ...
    :cond_5
    :goto_2
    iget-object v2, p0, Lretrofit2/q;->g:Lokhttp3/Request$Builder;
    ...
    iget-object v2, p0, Lretrofit2/q;->h:Lokhttp3/Headers$Builder;
    ...
    iget-object v2, p0, Lretrofit2/q;->d:Lokhttp3/HttpUrl;
    ...
    iget-object v2, p0, Lretrofit2/q;->e:Ljava/lang/String;
...
.method l(Lokhttp3/RequestBody;)V
    ...
    .line 1
    iput-object p1, p0, Lretrofit2/q;->m:Lokhttp3/RequestBody;
