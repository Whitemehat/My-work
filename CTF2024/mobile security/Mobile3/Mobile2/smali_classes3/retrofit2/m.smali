...
# direct methods
.method constructor <init>(Lretrofit2/r;[Ljava/lang/Object;Lokhttp3/Call$Factory;Lretrofit2/h;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    iput-object p3, p0, Lretrofit2/m;->c:Lokhttp3/Call$Factory;

    .line 5
    iput-object p4, p0, Lretrofit2/m;->d:Lretrofit2/h;
...
.method private c()Lokhttp3/Call;
    ...
    .line 1
    iget-object v0, p0, Lretrofit2/m;->c:Lokhttp3/Call$Factory;

    iget-object v1, p0, Lretrofit2/m;->a:Lretrofit2/r;

    iget-object v2, p0, Lretrofit2/m;->b:[Ljava/lang/Object;

    invoke-virtual {v1, v2}, Lretrofit2/r;->a([Ljava/lang/Object;)Lokhttp3/Request;
...
.method private d()Lokhttp3/Call;
    ...
    .line 1
    iget-object v0, p0, Lretrofit2/m;->f:Lokhttp3/Call;
    ...
    :cond_3
    :try_start_0
    invoke-direct {p0}, Lretrofit2/m;->c()Lokhttp3/Call;

    move-result-object v0

    iput-object v0, p0, Lretrofit2/m;->f:Lokhttp3/Call;
    :try_end_0
...
.method public b()Lretrofit2/m;
    ...
    iget-object v3, p0, Lretrofit2/m;->c:Lokhttp3/Call$Factory;

    iget-object v4, p0, Lretrofit2/m;->d:Lretrofit2/h;

    invoke-direct {v0, v1, v2, v3, v4}, Lretrofit2/m;-><init>(Lretrofit2/r;[Ljava/lang/Object;Lokhttp3/Call$Factory;Lretrofit2/h;)V
...
.method public d0(Lretrofit2/f;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object v2, p0, Lretrofit2/m;->f:Lokhttp3/Call;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .line 11
    invoke-interface {p1, p0, v1}, Lretrofit2/f;->onFailure(Lretrofit2/d;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v1, p0, p1}, Lretrofit2/m$a;-><init>(Lretrofit2/m;Lretrofit2/f;)V
...
.method e(Lokhttp3/Response;)Lretrofit2/s;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, v2, v3, v4}, Lretrofit2/m$c;-><init>(Lokhttp3/MediaType;J)V
    ...
    invoke-direct {v1, v0}, Lretrofit2/m$b;-><init>(Lokhttp3/ResponseBody;)V

    .line 7
    :try_start_0
    iget-object v0, p0, Lretrofit2/m;->d:Lretrofit2/h;
    ...
    .line 8
    invoke-static {v0, p1}, Lretrofit2/s;->g(Ljava/lang/Object;Lokhttp3/Response;)Lretrofit2/s;
    ...
    .line 9
    invoke-virtual {v1}, Lretrofit2/m$b;->a()V
    ...
    :goto_1
    :try_start_1
    invoke-static {v0}, Lretrofit2/x;->a(Lokhttp3/ResponseBody;)Lokhttp3/ResponseBody;

    move-result-object v1

    .line 14
    invoke-static {v1, p1}, Lretrofit2/s;->c(Lokhttp3/ResponseBody;Lokhttp3/Response;)Lretrofit2/s;
...
.method public execute()Lretrofit2/s;
    ...
    .line 4
    invoke-direct {p0}, Lretrofit2/m;->d()Lokhttp3/Call;
    ...
    invoke-virtual {p0, v0}, Lretrofit2/m;->e(Lokhttp3/Response;)Lretrofit2/s;
