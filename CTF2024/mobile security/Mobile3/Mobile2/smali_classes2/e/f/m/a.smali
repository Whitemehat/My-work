...
# instance fields
.field private final a:Le/f/m/l;
...
# direct methods
.method public constructor <init>(Le/f/m/l;Lcom/facebook/react/modules/core/b;Lcom/facebook/react/uimanager/n0;ZI)V
    .locals 0

    .line 1
    invoke-direct {p0}, Le/f/m/t;-><init>()V

    .line 2
    iput-object p1, p0, Le/f/m/a;->a:Le/f/m/l;

    .line 3
    iput-object p2, p0, Le/f/m/a;->b:Lcom/facebook/react/modules/core/b;

    .line 4
    iput-boolean p4, p0, Le/f/m/a;->c:Z

    .line 5
    iput p5, p0, Le/f/m/a;->d:I

    return-void
.end method

.method static synthetic g(Le/f/m/a;)Le/f/m/l;
    .locals 0

    .line 1
    iget-object p0, p0, Le/f/m/a;->a:Le/f/m/l;
...
.method private h(Lcom/facebook/react/bridge/ReactApplicationContext;)Lcom/facebook/react/uimanager/UIManagerModule;
    ...
    .line 3
    :try_start_0
    iget-boolean v2, p0, Le/f/m/a;->c:Z

    if-eqz v2, :cond_0

    .line 4
    new-instance v2, Le/f/m/a$b;

    invoke-direct {v2, p0}, Le/f/m/a$b;-><init>(Le/f/m/a;)V

    .line 5
    new-instance v3, Lcom/facebook/react/uimanager/UIManagerModule;

    iget v4, p0, Le/f/m/a;->d:I
    ...
    iget-object v3, p0, Le/f/m/a;->a:Le/f/m/l;

    .line 9
    invoke-virtual {v3, p1}, Le/f/m/l;->w(Lcom/facebook/react/bridge/ReactApplicationContext;)Ljava/util/List;
...
.method public c(Ljava/lang/String;Lcom/facebook/react/bridge/ReactApplicationContext;)Lcom/facebook/react/bridge/NativeModule;
    ...
    .line 3
    :pswitch_0
    invoke-direct {p0, p2}, Le/f/m/a;->h(Lcom/facebook/react/bridge/ReactApplicationContext;)Lcom/facebook/react/uimanager/UIManagerModule;
    ...
    iget-object p2, p0, Le/f/m/a;->a:Le/f/m/l;

    invoke-virtual {p2}, Le/f/m/l;->v()Lcom/facebook/react/devsupport/g/c;

    move-result-object p2

    invoke-direct {p1, p2}, Lcom/facebook/react/modules/core/ExceptionsManagerModule;-><init>(Lcom/facebook/react/devsupport/g/c;)V
    ...
    iget-object v0, p0, Le/f/m/a;->b:Lcom/facebook/react/modules/core/b;
    ...
    iget-object v0, p0, Le/f/m/a;->a:Le/f/m/l;

    invoke-virtual {v0}, Le/f/m/l;->v()Lcom/facebook/react/devsupport/g/c;

    move-result-object v0

    invoke-direct {p1, p2, v0}, Lcom/facebook/react/modules/debug/DevSettingsModule;-><init>(Lcom/facebook/react/bridge/ReactApplicationContext;Lcom/facebook/react/devsupport/g/c;)V
    ...
    invoke-direct {p1, p2, v0}, Lcom/facebook/react/modules/core/TimingModule;-><init>(Lcom/facebook/react/bridge/ReactApplicationContext;Lcom/facebook/react/devsupport/g/c;)V
    ...
    invoke-direct {p1, p2, v0}, Lcom/facebook/react/devsupport/LogBoxModule;-><init>(Lcom/facebook/react/bridge/ReactApplicationContext;Lcom/facebook/react/devsupport/g/c;)V
...
.method public e()Lcom/facebook/react/module/model/a;
    ...
    .line 8
    const-class v5, Le/f/m/x/a/a;

    invoke-virtual {v4, v5}, Ljava/lang/Class;->getAnnotation(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;

    move-result-object v5

    check-cast v5, Le/f/m/x/a/a;

    .line 9
    invoke-interface {v5}, Le/f/m/x/a/a;->name()Ljava/lang/String;
    ...
    .line 12
    invoke-interface {v5}, Le/f/m/x/a/a;->canOverrideExistingModule()Z

    move-result v10

    .line 13
    invoke-interface {v5}, Le/f/m/x/a/a;->needsEagerInit()Z

    move-result v11

    .line 14
    invoke-interface {v5}, Le/f/m/x/a/a;->hasConstants()Z

    move-result v12

    .line 15
    invoke-interface {v5}, Le/f/m/x/a/a;->isCxxModule()Z
    ...
    .line 18
    :cond_0
    new-instance v0, Le/f/m/a$a;

    move-object/from16 v1, p0

    invoke-direct {v0, v1, v2}, Le/f/m/a$a;-><init>(Le/f/m/a;Ljava/util/Map;)V
