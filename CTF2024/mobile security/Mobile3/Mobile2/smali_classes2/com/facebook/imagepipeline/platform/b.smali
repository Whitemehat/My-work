...
.field final e:Landroidx/core/util/g;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public constructor <init>(Lcom/facebook/imagepipeline/memory/c;ILandroidx/core/util/g;)V
    .locals 2
    ...
    .line 4
    iput-object p3, p0, Lcom/facebook/imagepipeline/platform/b;->e:Landroidx/core/util/g;
    ...
    .line 5
    iget-object p3, p0, Lcom/facebook/imagepipeline/platform/b;->e:Landroidx/core/util/g;
    ...
    invoke-virtual {p3, v0}, Landroidx/core/util/g;->release(Ljava/lang/Object;)Z
...
.method private d(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;Landroid/graphics/Rect;Landroid/graphics/ColorSpace;)Lcom/facebook/common/references/a;
    ...
    .line 12
    iget-object v8, p0, Lcom/facebook/imagepipeline/platform/b;->c:Lcom/facebook/imagepipeline/memory/c;
    ...
    .line 17
    :cond_5
    iget-object p4, p0, Lcom/facebook/imagepipeline/platform/b;->e:Landroidx/core/util/g;

    invoke-virtual {p4}, Landroidx/core/util/g;->acquire()Ljava/lang/Object;
    ...
    invoke-static {v1, v2, v3}, Le/f/d/d/a;->g(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_4
    ...
    .line 27
    :cond_9
    iget-object p1, p0, Lcom/facebook/imagepipeline/platform/b;->e:Landroidx/core/util/g;

    invoke-virtual {p1, p4}, Landroidx/core/util/g;->release(Ljava/lang/Object;)Z
    ...
    invoke-static {p3, p1}, Lcom/facebook/common/references/a;->e0(Ljava/lang/Object;Lcom/facebook/common/references/c;)Lcom/facebook/common/references/a;
    ...
    invoke-static {p1, p3}, Lcom/facebook/common/references/a;->e0(Ljava/lang/Object;Lcom/facebook/common/references/c;)Lcom/facebook/common/references/a;
    ...
    .line 38
    iget-object p2, p0, Lcom/facebook/imagepipeline/platform/b;->e:Landroidx/core/util/g;

    invoke-virtual {p2, p4}, Landroidx/core/util/g;->release(Ljava/lang/Object;)Z
...
.method private static f(Le/f/j/i/d;Landroid/graphics/Bitmap$Config;)Landroid/graphics/BitmapFactory$Options;
    .locals 3
    ...
    .line 2
    invoke-virtual {p0}, Le/f/j/i/d;->G()I
...
.method public a(Le/f/j/i/d;Landroid/graphics/Bitmap$Config;Landroid/graphics/Rect;Landroid/graphics/ColorSpace;)Lcom/facebook/common/references/a;
    ...
    .line 1
    invoke-static {p1, p2}, Lcom/facebook/imagepipeline/platform/b;->f(Le/f/j/i/d;Landroid/graphics/Bitmap$Config;)Landroid/graphics/BitmapFactory$Options;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/facebook/imagepipeline/platform/b;->a(Le/f/j/i/d;Landroid/graphics/Bitmap$Config;Landroid/graphics/Rect;Landroid/graphics/ColorSpace;)Lcom/facebook/common/references/a;
...
.method public b(Le/f/j/i/d;Landroid/graphics/Bitmap$Config;Landroid/graphics/Rect;I)Lcom/facebook/common/references/a;
    ...
    .line 1
    invoke-virtual/range {v0 .. v5}, Lcom/facebook/imagepipeline/platform/b;->c(Le/f/j/i/d;Landroid/graphics/Bitmap$Config;Landroid/graphics/Rect;ILandroid/graphics/ColorSpace;)Lcom/facebook/common/references/a;
...
.method public c(Le/f/j/i/d;Landroid/graphics/Bitmap$Config;Landroid/graphics/Rect;ILandroid/graphics/ColorSpace;)Lcom/facebook/common/references/a;
    ...
    .line 1
    invoke-virtual {p1, p4}, Le/f/j/i/d;->O(I)Z
    ...
    .line 6
    new-instance v2, Le/f/d/g/a;

    invoke-direct {v2, v1, p4}, Le/f/d/g/a;-><init>(Ljava/io/InputStream;I)V
    ...
    .line 7
    new-instance v0, Le/f/d/g/b;

    sget-object v2, Lcom/facebook/imagepipeline/platform/b;->b:[B

    invoke-direct {v0, v1, v2}, Le/f/d/g/b;-><init>(Ljava/io/InputStream;[B)V
    ...
    invoke-virtual/range {v1 .. v6}, Lcom/facebook/imagepipeline/platform/b;->c(Le/f/j/i/d;Landroid/graphics/Bitmap$Config;Landroid/graphics/Rect;ILandroid/graphics/ColorSpace;)Lcom/facebook/common/references/a;
