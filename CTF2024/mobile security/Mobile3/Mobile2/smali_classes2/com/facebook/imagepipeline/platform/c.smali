...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/facebook/imagepipeline/platform/c;->d:Le/f/d/h/b;

    return-void
.end method

.method private static i(Lcom/facebook/common/references/a;I[B)Landroid/os/MemoryFile;
    .locals 7
    ...
    .line 5
    :try_start_1
    new-instance v5, Le/f/d/g/a;

    invoke-direct {v5, v4, p1}, Le/f/d/g/a;-><init>(Ljava/io/InputStream;I)V
    :try_end_1
    ...
    .line 7
    invoke-static {v5, v3}, Le/f/d/c/a;->a(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    ...
    .line 10
    invoke-static {v4}, Le/f/d/c/b;->b(Ljava/io/InputStream;)V

    .line 11
    invoke-static {v5}, Le/f/d/c/b;->b(Ljava/io/InputStream;)V

    .line 12
    invoke-static {v3, v1}, Le/f/d/c/b;->a(Ljava/io/Closeable;Z)V
    ...
    .line 14
    invoke-static {v3}, Le/f/d/c/b;->b(Ljava/io/InputStream;)V

    .line 15
    invoke-static {v5}, Le/f/d/c/b;->b(Ljava/io/InputStream;)V

    .line 16
    invoke-static {p2, v1}, Le/f/d/c/b;->a(Ljava/io/Closeable;Z)V

    throw p1
.end method

.method private j(Lcom/facebook/common/references/a;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    :try_start_0
    invoke-static {p1, p2, p3}, Lcom/facebook/imagepipeline/platform/c;->i(Lcom/facebook/common/references/a;I[B)Landroid/os/MemoryFile;
    ...
    .line 3
    iget-object p3, p0, Lcom/facebook/imagepipeline/platform/c;->d:Le/f/d/h/b;

    if-eqz p3, :cond_1

    .line 4
    invoke-interface {p3, p2, v0, p4}, Le/f/d/h/b;->c(Ljava/io/FileDescriptor;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    .line 5
    invoke-static {p2, p3}, Le/f/d/c/i;->h(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :goto_0
    :try_start_3
    invoke-static {p2}, Le/f/d/c/n;->a(Ljava/lang/Throwable;)Ljava/lang/RuntimeException;
...
.method private declared-synchronized k()Ljava/lang/reflect/Method;
    ...
    .line 1
    :try_start_0
    sget-object v0, Lcom/facebook/imagepipeline/platform/c;->c:Ljava/lang/reflect/Method;
    :try_end_0
    ...
    sput-object v0, Lcom/facebook/imagepipeline/platform/c;->c:Ljava/lang/reflect/Method;
    :try_end_1
...
.method protected d(Lcom/facebook/common/references/a;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, p1, v0, v1, p2}, Lcom/facebook/imagepipeline/platform/c;->j(Lcom/facebook/common/references/a;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method protected e(Lcom/facebook/common/references/a;ILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    .line 2
    :goto_0
    invoke-direct {p0, p1, p2, v0, p3}, Lcom/facebook/imagepipeline/platform/c;->j(Lcom/facebook/common/references/a;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
