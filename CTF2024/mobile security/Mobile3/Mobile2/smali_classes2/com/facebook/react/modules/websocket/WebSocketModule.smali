...
.method public close(DLjava/lang/String;D)V
    ...
    invoke-static {p3, p2, p1}, Le/f/d/d/a;->j(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public connect(Ljava/lang/String;Lcom/facebook/react/bridge/ReadableArray;Lcom/facebook/react/bridge/ReadableMap;D)V
    ...
    invoke-static {v7, v6}, Le/f/d/d/a;->A(Ljava/lang/String;Ljava/lang/String;)V
...
.method public ping(D)V
    ...
    invoke-interface {p2, v0}, Lokhttp3/WebSocket;->send(Lj/i;)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public sendBinary(Lj/i;I)V
    .locals 3
...
.method public sendBinary(Ljava/lang/String;D)V
    ...
    :cond_0
    :try_start_0
    invoke-static {p1}, Lj/i;->q(Ljava/lang/String;)Lj/i;

    move-result-object p1

    invoke-interface {p3, p1}, Lokhttp3/WebSocket;->send(Lj/i;)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
