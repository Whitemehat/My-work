...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/facebook/react/views/text/p;->e0:Landroid/text/TextPaint;
...
.method public constructor <init>()V
    ...
    .line 1
    invoke-direct {p0, v0}, Lcom/facebook/react/views/text/p;-><init>(Lcom/facebook/react/views/text/s;)V
...
.method public constructor <init>(Lcom/facebook/react/views/text/s;)V
    ...
    .line 3
    new-instance p1, Lcom/facebook/react/views/text/p$a;

    invoke-direct {p1, p0}, Lcom/facebook/react/views/text/p$a;-><init>(Lcom/facebook/react/views/text/p;)V

    iput-object p1, p0, Lcom/facebook/react/views/text/p;->h0:Lcom/facebook/yoga/m;

    .line 4
    invoke-direct {p0}, Lcom/facebook/react/views/text/p;->v1()V

    return-void
.end method

.method static synthetic q1(Lcom/facebook/react/views/text/p;)Landroid/text/Spannable;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/facebook/react/views/text/p;->f0:Landroid/text/Spannable;

    return-object p0
.end method

.method static synthetic r1(Lcom/facebook/react/views/text/p;Landroid/text/Spannable;FLcom/facebook/yoga/n;)Landroid/text/Layout;
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p3}, Lcom/facebook/react/views/text/p;->w1(Landroid/text/Spannable;FLcom/facebook/yoga/n;)Landroid/text/Layout;
...
.method static synthetic s1(Lcom/facebook/react/views/text/p;)Z
    .locals 0

    .line 1
    iget-boolean p0, p0, Lcom/facebook/react/views/text/p;->g0:Z

    return p0
.end method

.method static synthetic t1()Landroid/text/TextPaint;
    .locals 1

    .line 1
    sget-object v0, Lcom/facebook/react/views/text/p;->e0:Landroid/text/TextPaint;
...
.method private u1()I
    ...
    .line 2
    invoke-virtual {p0}, Lcom/facebook/react/uimanager/z;->f0()Lcom/facebook/yoga/h;

    move-result-object v1

    sget-object v2, Lcom/facebook/yoga/h;->c:Lcom/facebook/yoga/h;
...
.method private v1()V
    ...
    .line 2
    iget-object v0, p0, Lcom/facebook/react/views/text/p;->h0:Lcom/facebook/yoga/m;

    invoke-virtual {p0, v0}, Lcom/facebook/react/uimanager/z;->R0(Lcom/facebook/yoga/m;)V

    :cond_0
    return-void
.end method

.method private w1(Landroid/text/Spannable;FLcom/facebook/yoga/n;)Landroid/text/Layout;
    .locals 11

    .line 1
    sget-object v2, Lcom/facebook/react/views/text/p;->e0:Landroid/text/TextPaint;
    ...
    .line 5
    :goto_0
    sget-object v1, Lcom/facebook/yoga/n;->a:Lcom/facebook/yoga/n;
    ...
    .line 7
    invoke-direct {p0}, Lcom/facebook/react/views/text/p;->u1()I
...
.method public U(Lcom/facebook/react/uimanager/m;)V
    ...
    .line 1
    invoke-virtual {p0, p0, v0, v1, p1}, Lcom/facebook/react/views/text/h;->p1(Lcom/facebook/react/views/text/h;Ljava/lang/String;ZLcom/facebook/react/uimanager/m;)Landroid/text/Spannable;

    move-result-object p1

    iput-object p1, p0, Lcom/facebook/react/views/text/p;->f0:Landroid/text/Spannable;

    .line 2
    invoke-virtual {p0}, Lcom/facebook/react/views/text/p;->w0()V
...
.method public n()Ljava/lang/Iterable;
    ...
    .line 2
    :cond_0
    iget-object v0, p0, Lcom/facebook/react/views/text/p;->f0:Landroid/text/Spannable;
    ...
    invoke-virtual {v4}, Lcom/facebook/react/views/text/a0;->b()I
    ...
    .line 8
    invoke-interface {v4}, Lcom/facebook/react/uimanager/y;->s()V
...
.method public setShouldNotifyOnTextLayout(Z)V
    ...
    .line 1
    iput-boolean p1, p0, Lcom/facebook/react/views/text/p;->g0:Z
...
.method public w0()V
    ...
    .line 1
    invoke-super {p0}, Lcom/facebook/react/uimanager/z;->w0()V

    .line 2
    invoke-super {p0}, Lcom/facebook/react/uimanager/z;->h()V
...
.method public y0(Lcom/facebook/react/uimanager/t0;)V
    ...
    .line 1
    invoke-super {p0, p1}, Lcom/facebook/react/uimanager/z;->y0(Lcom/facebook/react/uimanager/t0;)V

    .line 2
    iget-object v1, p0, Lcom/facebook/react/views/text/p;->f0:Landroid/text/Spannable;
    ...
    .line 4
    invoke-virtual {p0, v0}, Lcom/facebook/react/uimanager/z;->j0(I)F
    ...
    invoke-virtual {p1, v0, v11}, Lcom/facebook/react/uimanager/t0;->R(ILjava/lang/Object;)V
