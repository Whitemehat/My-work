.class public Lcom/facebook/react/views/view/c;
...
.method public static a(Landroid/content/Context;Lcom/facebook/react/bridge/ReadableMap;)Landroid/graphics/drawable/Drawable;
    ...
    sget-object v4, Lcom/facebook/react/views/view/c;->a:Landroid/util/TypedValue;
    ...
    .line 7
    invoke-static {p0}, Lcom/facebook/react/views/view/c;->c(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;

    move-result-object p0

    .line 8
    invoke-static {p1, p0}, Lcom/facebook/react/views/view/c;->f(Lcom/facebook/react/bridge/ReadableMap;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 12
    invoke-static {p0, p1}, Lcom/facebook/react/views/view/c;->e(Landroid/content/Context;Lcom/facebook/react/bridge/ReadableMap;)Landroid/graphics/drawable/RippleDrawable;
...
.method private static b(Landroid/content/Context;Lcom/facebook/react/bridge/ReadableMap;)I
    .locals 3
...
.method private static c(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    sget-object v0, Lcom/facebook/react/views/view/c;->a:Landroid/util/TypedValue;
...
.method private static d(Lcom/facebook/react/bridge/ReadableMap;)Landroid/graphics/drawable/Drawable;
    .locals 2
...
.method private static e(Landroid/content/Context;Lcom/facebook/react/bridge/ReadableMap;)Landroid/graphics/drawable/RippleDrawable;
    .locals 5
    ...
    .line 2
    invoke-static {p0, p1}, Lcom/facebook/react/views/view/c;->b(Landroid/content/Context;Lcom/facebook/react/bridge/ReadableMap;)I

    move-result p0

    .line 3
    invoke-static {p1}, Lcom/facebook/react/views/view/c;->d(Lcom/facebook/react/bridge/ReadableMap;)Landroid/graphics/drawable/Drawable;
...
.method private static f(Lcom/facebook/react/bridge/ReadableMap;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    .locals 4
