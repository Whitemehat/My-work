...
.field private j:Landroid/hardware/biometrics/BiometricPrompt;

.field private k:Landroid/os/CancellationSignal;
...
.field private final t:Landroid/content/DialogInterface$OnClickListener;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/biometric/a;->m:Landroid/os/Handler;
    ...
    iput-object v0, p0, Landroidx/biometric/a;->n:Ljava/util/concurrent/Executor;
    ...
    iput-object v0, p0, Landroidx/biometric/a;->p:Landroid/hardware/biometrics/BiometricPrompt$AuthenticationCallback;
    ...
    iput-object v0, p0, Landroidx/biometric/a;->q:Landroid/content/DialogInterface$OnClickListener;
    ...
    iput-object v0, p0, Landroidx/biometric/a;->t:Landroid/content/DialogInterface$OnClickListener;

    return-void
.end method

.method static synthetic d(Landroidx/biometric/a;)Landroid/os/Handler;
    .locals 0

    .line 1
    iget-object p0, p0, Landroidx/biometric/a;->m:Landroid/os/Handler;

    return-object p0
.end method

.method static synthetic e(Landroidx/biometric/a;)Landroid/content/Context;
    .locals 0

    .line 1
    iget-object p0, p0, Landroidx/biometric/a;->a:Landroid/content/Context;
...
.method static synthetic f(Landroid/hardware/biometrics/BiometricPrompt$CryptoObject;)Landroidx/biometric/BiometricPrompt$d;
    ...
    .line 1
    invoke-static {p0}, Landroidx/biometric/a;->q(Landroid/hardware/biometrics/BiometricPrompt$CryptoObject;)Landroidx/biometric/BiometricPrompt$d;
...
.method static synthetic g(Landroidx/biometric/a;)Landroid/os/Bundle;
    .locals 0

    .line 1
    iget-object p0, p0, Landroidx/biometric/a;->b:Landroid/os/Bundle;

    return-object p0
.end method

.method static synthetic h(Landroidx/biometric/a;Z)Z
    .locals 0

    .line 1
    iput-boolean p1, p0, Landroidx/biometric/a;->l:Z

    return p1
.end method

.method static m()Landroidx/biometric/a;
    .locals 1
...
.method i()V
    ...
    invoke-virtual {p0}, Landroidx/biometric/a;->l()Z
    ...
    .line 2
    iget-boolean v0, p0, Landroidx/biometric/a;->l:Z
    ...
    .line 4
    :cond_0
    iget-object v0, p0, Landroidx/biometric/a;->k:Landroid/os/CancellationSignal;
    ...
    .line 6
    :cond_1
    invoke-virtual {p0}, Landroidx/biometric/a;->j()V
...
.method protected k()Ljava/lang/CharSequence;
    ...
    .line 1
    iget-object v0, p0, Landroidx/biometric/a;->g:Ljava/lang/CharSequence;
...
.method l()Z
    ...
    .line 1
    iget-object v0, p0, Landroidx/biometric/a;->b:Landroid/os/Bundle;
...
.method n(Landroid/os/Bundle;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/biometric/a;->b:Landroid/os/Bundle;
...
.method o(Ljava/util/concurrent/Executor;Landroid/content/DialogInterface$OnClickListener;Landroidx/biometric/BiometricPrompt$b;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/biometric/a;->c:Ljava/util/concurrent/Executor;

    .line 2
    iput-object p2, p0, Landroidx/biometric/a;->d:Landroid/content/DialogInterface$OnClickListener;

    .line 3
    iput-object p3, p0, Landroidx/biometric/a;->e:Landroidx/biometric/BiometricPrompt$b;
...
.method public onAttach(Landroid/content/Context;)V
    ...
    .line 2
    iput-object p1, p0, Landroidx/biometric/a;->a:Landroid/content/Context;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .line 1
    iget-boolean v0, p0, Landroidx/biometric/a;->h:Z
    ...
    iput-object v0, p0, Landroidx/biometric/a;->g:Ljava/lang/CharSequence;
    ...
    .line 5
    iget-object v2, p0, Landroidx/biometric/a;->b:Landroid/os/Bundle;
    ...
    iget-object v3, p0, Landroidx/biometric/a;->b:Landroid/os/Bundle;
    ...
    iput-object v3, p0, Landroidx/biometric/a;->g:Ljava/lang/CharSequence;

    .line 12
    iget-object v4, p0, Landroidx/biometric/a;->c:Ljava/util/concurrent/Executor;

    iget-object v5, p0, Landroidx/biometric/a;->t:Landroid/content/DialogInterface$OnClickListener;
    ...
    .line 13
    :cond_0
    iget-object v3, p0, Landroidx/biometric/a;->g:Ljava/lang/CharSequence;
    ...
    iget-object v5, p0, Landroidx/biometric/a;->q:Landroid/content/DialogInterface$OnClickListener;
    ...
    .line 20
    iput-boolean v2, p0, Landroidx/biometric/a;->l:Z

    .line 21
    iget-object v2, p0, Landroidx/biometric/a;->m:Landroid/os/Handler;
    ...
    iput-object v0, p0, Landroidx/biometric/a;->j:Landroid/hardware/biometrics/BiometricPrompt;
    ...
    iput-object v0, p0, Landroidx/biometric/a;->k:Landroid/os/CancellationSignal;

    .line 24
    iget-object v2, p0, Landroidx/biometric/a;->f:Landroidx/biometric/BiometricPrompt$d;

    if-nez v2, :cond_4

    .line 25
    iget-object v2, p0, Landroidx/biometric/a;->j:Landroid/hardware/biometrics/BiometricPrompt;

    iget-object v3, p0, Landroidx/biometric/a;->n:Ljava/util/concurrent/Executor;

    iget-object v4, p0, Landroidx/biometric/a;->p:Landroid/hardware/biometrics/BiometricPrompt$AuthenticationCallback;
    ...
    .line 26
    :cond_4
    iget-object v0, p0, Landroidx/biometric/a;->j:Landroid/hardware/biometrics/BiometricPrompt;

    invoke-static {v2}, Landroidx/biometric/a;->r(Landroidx/biometric/BiometricPrompt$d;)Landroid/hardware/biometrics/BiometricPrompt$CryptoObject;

    move-result-object v2

    iget-object v3, p0, Landroidx/biometric/a;->k:Landroid/os/CancellationSignal;

    iget-object v4, p0, Landroidx/biometric/a;->n:Ljava/util/concurrent/Executor;

    iget-object v5, p0, Landroidx/biometric/a;->p:Landroid/hardware/biometrics/BiometricPrompt$AuthenticationCallback;
    ...
    :cond_5
    :goto_1
    iput-boolean v1, p0, Landroidx/biometric/a;->h:Z
...
.method p(Landroidx/biometric/BiometricPrompt$d;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/biometric/a;->f:Landroidx/biometric/BiometricPrompt$d;
