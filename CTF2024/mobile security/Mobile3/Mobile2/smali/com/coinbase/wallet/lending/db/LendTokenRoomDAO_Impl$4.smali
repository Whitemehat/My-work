.class Lcom/coinbase/wallet/lending/db/LendTokenRoomDAO_Impl$4;
...
.method constructor <init>(Lcom/coinbase/wallet/lending/db/LendTokenRoomDAO_Impl;Landroidx/room/j;)V
    ...
    .line 1
    iput-object p1, p0, Lcom/coinbase/wallet/lending/db/LendTokenRoomDAO_Impl$4;->this$0:Lcom/coinbase/wallet/lending/db/LendTokenRoomDAO_Impl;
...
.method public bind(Lc/r/a/f;Lcom/coinbase/wallet/lending/models/LendToken;)V
    ...
    .line 11
    :goto_2
    iget-object v0, p0, Lcom/coinbase/wallet/lending/db/LendTokenRoomDAO_Impl$4;->this$0:Lcom/coinbase/wallet/lending/db/LendTokenRoomDAO_Impl;
...
.method public bridge synthetic bind(Lc/r/a/f;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/coinbase/wallet/lending/db/LendTokenRoomDAO_Impl$4;->bind(Lc/r/a/f;Lcom/coinbase/wallet/lending/models/LendToken;)V
...
.method public createQuery()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `LendToken` SET `id` = ?,`walletAddress` = ?,`name` = ?,`currencyCode` = ?,`decimals` = ?,`imageURL` = ?,`contractAddress` = ?,`supplyBalance` = ?,`supplyInterestRate` = ?,`globalSuppliedAmount` = ?,`utilizationRate` = ?,`collateralRate` = ?,`isCollateralRateApplicable` = ?,`providerID` = ?,`providerName` = ?,`providerWebsiteURL` = ?,`providerImageURL` = ?,`rateDecimals` = ? WHERE `id` = ?"
