.class public final Lcom/coinbase/wallet/consumer/daos/ConsumerAccountsDAO$save$$inlined$addOrUpdate$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/coinbase/wallet/consumer/daos/ConsumerAccountsDAO;->save(Ljava/util/List;)Lh/c/b0;
.end annotation
...
.method public constructor <init>(Lcom/coinbase/wallet/libraries/databases/model/DatabaseOperation;Lcom/coinbase/wallet/libraries/databases/db/Storage;Ljava/util/List;)V
    ...
    iput-object p1, p0, Lcom/coinbase/wallet/consumer/daos/ConsumerAccountsDAO$save$$inlined$addOrUpdate$1;->$operation:Lcom/coinbase/wallet/libraries/databases/model/DatabaseOperation;

    iput-object p2, p0, Lcom/coinbase/wallet/consumer/daos/ConsumerAccountsDAO$save$$inlined$addOrUpdate$1;->this$0:Lcom/coinbase/wallet/libraries/databases/db/Storage;

    iput-object p3, p0, Lcom/coinbase/wallet/consumer/daos/ConsumerAccountsDAO$save$$inlined$addOrUpdate$1;->$models$inlined:Ljava/util/List;
...
.method public final subscribe(Lh/c/d0;)V
    ...
    .line 1
    iget-object v0, p0, Lcom/coinbase/wallet/consumer/daos/ConsumerAccountsDAO$save$$inlined$addOrUpdate$1;->$operation:Lcom/coinbase/wallet/libraries/databases/model/DatabaseOperation;

    sget-object v1, Lcom/coinbase/wallet/consumer/daos/ConsumerAccountsDAO$save$$inlined$addOrUpdate$1$1$wm$Storage$perform$1$WhenMappings;->$EnumSwitchMapping$0:[I
    ...
    .line 2
    iget-object v0, p0, Lcom/coinbase/wallet/consumer/daos/ConsumerAccountsDAO$save$$inlined$addOrUpdate$1;->this$0:Lcom/coinbase/wallet/libraries/databases/db/Storage;
    ...
    .line 4
    :goto_0
    iget-object v1, p0, Lcom/coinbase/wallet/consumer/daos/ConsumerAccountsDAO$save$$inlined$addOrUpdate$1;->this$0:Lcom/coinbase/wallet/libraries/databases/db/Storage;

    invoke-virtual {v1}, Lcom/coinbase/wallet/libraries/databases/db/Storage;->getModelDaos()Ljava/util/Map;

    move-result-object v1

    const-class v2, Lcom/coinbase/wallet/consumer/models/ConsumerAccount;
    ...
    .line 7
    iget-object v2, p0, Lcom/coinbase/wallet/consumer/daos/ConsumerAccountsDAO$save$$inlined$addOrUpdate$1;->this$0:Lcom/coinbase/wallet/libraries/databases/db/Storage;
    ...
    :cond_4
    :try_start_0
    iget-object v2, p0, Lcom/coinbase/wallet/consumer/daos/ConsumerAccountsDAO$save$$inlined$addOrUpdate$1;->$models$inlined:Ljava/util/List;
    ...
    .line 11
    iget-object v1, p0, Lcom/coinbase/wallet/consumer/daos/ConsumerAccountsDAO$save$$inlined$addOrUpdate$1;->$models$inlined:Ljava/util/List;
