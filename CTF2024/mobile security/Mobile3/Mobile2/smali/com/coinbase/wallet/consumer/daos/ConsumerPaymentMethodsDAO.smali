.class public final Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO;
.super Ljava/lang/Object;
.source "ConsumerPaymentMethodsDAO.kt"
...
.method public constructor <init>(Lcom/coinbase/wallet/libraries/databases/db/Database;)V
    ...
    iput-object p1, p0, Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO;->db:Lcom/coinbase/wallet/libraries/databases/db/Database;

    return-void
.end method

.method public static synthetic a(Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO;Lcom/coinbase/wallet/consumer/models/ConsumerPaymentMethod;)Lh/c/x;
    .locals 0

    invoke-static {p0, p1}, Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO;->observePaymentMethods$lambda-3(Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO;Lcom/coinbase/wallet/consumer/models/ConsumerPaymentMethod;)Lh/c/x;
...
.method public static synthetic b(Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO;Ljava/util/List;)Lh/c/h0;
    .locals 0

    invoke-static {p0, p1}, Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO;->deleteAll$lambda-1(Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO;Ljava/util/List;)Lh/c/h0;
...
.method public static synthetic c(Lcom/coinbase/wallet/core/util/Optional;)Ljava/util/List;
    .locals 0

    invoke-static {p0}, Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO;->save$lambda-2(Lcom/coinbase/wallet/core/util/Optional;)Ljava/util/List;
...
.method private static final deleteAll$lambda-1(Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO;Ljava/util/List;)Lh/c/h0;
    .locals 5
    ...
    .line 4
    iget-object v2, p0, Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO;->db:Lcom/coinbase/wallet/libraries/databases/db/Database;
    ...
    .line 7
    new-instance v4, Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO$deleteAll$lambda-1$lambda-0$$inlined$delete$1;

    invoke-direct {v4, v3, v2, v1}, Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO$deleteAll$lambda-1$lambda-0$$inlined$delete$1;-><init>(Lcom/coinbase/wallet/libraries/databases/model/DatabaseOperation;Lcom/coinbase/wallet/libraries/databases/db/Storage;Lcom/coinbase/wallet/libraries/databases/interfaces/DatabaseModelObject;)V
    ...
    .line 14
    :cond_1
    new-instance p0, Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO$deleteAll$lambda-1$$inlined$zipOrEmpty$1;

    invoke-direct {p0}, Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO$deleteAll$lambda-1$$inlined$zipOrEmpty$1;-><init>()V
...
.method private final getPaymentMethods()Lh/c/b0;
    ...
    .line 1
    iget-object v3, p0, Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO;->db:Lcom/coinbase/wallet/libraries/databases/db/Database;
    ...
    .line 4
    new-instance v7, Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO$getPaymentMethods$$inlined$fetch$1;

    const-string v4, "SELECT * FROM paymentMethods"

    move-object v0, v7

    move-object v2, v6

    invoke-direct/range {v0 .. v5}, Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO$getPaymentMethods$$inlined$fetch$1;-><init>(Lcom/coinbase/wallet/libraries/databases/model/DatabaseOperation;Lcom/coinbase/wallet/libraries/databases/db/Storage;Lcom/coinbase/wallet/libraries/databases/db/Database;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private static final observePaymentMethods$lambda-3(Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO;Lcom/coinbase/wallet/consumer/models/ConsumerPaymentMethod;)Lh/c/x;
    .locals 1
    ...
    .line 1
    invoke-direct {p0}, Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO;->getPaymentMethods()Lh/c/b0;
...
.method public final deleteAll()Lh/c/b0;
    ...
    .line 4
    new-instance v7, Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO$deleteAll$$inlined$fetch$1;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO$deleteAll$$inlined$fetch$1;-><init>(Lcom/coinbase/wallet/libraries/databases/model/DatabaseOperation;Lcom/coinbase/wallet/libraries/databases/db/Storage;Lcom/coinbase/wallet/libraries/databases/db/Database;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 7
    new-instance v1, Lcom/coinbase/wallet/consumer/daos/h;

    invoke-direct {v1, p0}, Lcom/coinbase/wallet/consumer/daos/h;-><init>(Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO;)V

    invoke-virtual {v0, v1}, Lh/c/b0;->flatMap(Lh/c/m0/n;)Lh/c/b0;

    move-result-object v0

    const-string v1, "db.fetch<ConsumerPaymentMethod>(query)\n            .flatMap { records -> records.map { db.delete(it) }.zipOrEmpty() }"
...
.method public final observePaymentMethods()Lh/c/s;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 1
    iget-object v0, p0, Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO;->db:Lcom/coinbase/wallet/libraries/databases/db/Database;
    ...
    const-class v3, Lcom/coinbase/wallet/consumer/models/ConsumerPaymentMethod;
    ...
    const-class v4, Lcom/coinbase/wallet/consumer/models/ConsumerPaymentMethod;
    ...
    .line 14
    new-instance v1, Lcom/coinbase/wallet/consumer/daos/g;

    invoke-direct {v1, p0}, Lcom/coinbase/wallet/consumer/daos/g;-><init>(Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO;)V
...
.method public final save(Ljava/util/List;)Lh/c/b0;
    ...
    .line 4
    new-instance v3, Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO$save$$inlined$addOrUpdate$1;

    invoke-direct {v3, v2, v1, p1}, Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO$save$$inlined$addOrUpdate$1;-><init>(Lcom/coinbase/wallet/libraries/databases/model/DatabaseOperation;Lcom/coinbase/wallet/libraries/databases/db/Storage;Ljava/util/List;)V
    ...
    .line 7
    new-instance v2, Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO$save$$inlined$addOrUpdate$2;

    invoke-direct {v2, p1, v0}, Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO$save$$inlined$addOrUpdate$2;-><init>(Ljava/util/List;Lcom/coinbase/wallet/libraries/databases/db/Database;)V
    ...
    sget-object v0, Lcom/coinbase/wallet/consumer/daos/i;->a:Lcom/coinbase/wallet/consumer/daos/i;
